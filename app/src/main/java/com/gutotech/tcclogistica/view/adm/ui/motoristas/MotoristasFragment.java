...
public class MotoristasFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        View root = inflater.inflate(R.layout.fragment_motoristas, container, false);
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                switch (menuItem.getItemId()) {
                    case R.id.action_novo:
                        changeToFragment(new MotoristaNovoFragment());
                        break;
                    case R.id.action_cadastrados:
                        changeToFragment(new MotoristasCadastradosFragment());
                        break;
                }
