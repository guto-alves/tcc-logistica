...
public class MotoristaEntregasRealizadasFragment extends Fragment {
    ...
    public MotoristaEntregasRealizadasFragment() {
    }

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        View root = inflater.inflate(R.layout.fragment_motorista_entregas_realizadas, container, false);
    ...
    private void carregarEntregas() {
        ...
        entregasPedentesQuery = entregasReference.orderByChild("status").equalTo(Entrega.Status.REALIZADA.toString());
